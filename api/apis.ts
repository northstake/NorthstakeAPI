...
import { AccountWebhooksApi } from './accountWebhooksApi';
...
export * from './lidoSVMProApi';
import { LidoSVMProApi } from './lidoSVMProApi';
...
export const APIS = [AccountApi, AccountApiKeysApi, AccountWebhooksApi, LidoReadApi, LidoRewardsApi, LidoSVMProApi, LidoStakingVaultsApi, LidoWriteApi, LinkedWalletsApi, NotificationsApi, OrganizationApi, ValidatorsApi];

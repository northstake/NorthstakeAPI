...
export const APIS = [AccountApi, AccountApiKeysApi, LidoReadApi, LidoRewardsApi, LidoSVMProApi, LidoStakingVaultsApi, LidoWriteApi, LinkedWalletsApi, NotificationsApi, OrganizationApi, ValidatorsApi];

...
export class AccountApiKeysApi {
   ...
   public async listApiKeys (options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ body: Array<ApiKey>, status: number }> {
    ...
    /**
     * Update the name, whitelisted IPs, or key rights of an existing API key.
   ...
   public async updateApiKey (apiKeyId: string, updateApiKeyRequest: UpdateApiKeyRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ body: ApiKey, status: number }> {
        ...
        if (updateApiKeyRequest === null || updateApiKeyRequest === undefined) {
            throw new Error('Required parameter "updateApiKeyRequest" was null or undefined when calling updateApiKey.');
        }

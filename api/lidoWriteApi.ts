...
import { DepositAndMintSteth } from '../model/depositAndMintSteth';
import { DepositAndMintWsteth } from '../model/depositAndMintWsteth';
...
import { LazyOracleReportCallDataResponse } from '../model/lazyOracleReportCallDataResponse';
...
import { SetFeeRateRequest } from '../model/setFeeRateRequest';
import { SetFeeRecipientRequest } from '../model/setFeeRecipientRequest';
...
export class LidoWriteApi {
   ...
   public async consolidateValidators (contractsId: string, consolidateValidators: ConsolidateValidators, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ body: ConsolidateValidatorsResponse, status: number }> {
    ...
    /**
     * Generates the encoded transaction to deposit ETH into an StvStETH pool and optionally mint stETH in the same transaction. The stETH amount is converted to the equivalent stETH shares on-chain before minting. Only supported for StvStETH pool vaults. 
     * @summary Deposit ETH and optionally mint stETH in an StvStETH pool
     * @param contractsId The unique identifier of the Lido staking contracts
     * @param depositAndMintSteth 
     */
   ...
   public async depositAndMintSteth (contractsId: string, depositAndMintSteth: DepositAndMintSteth, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ body: PartialTransaction, status: number }> {

        const localVarPath = this.basePath + '/lidov3/{contractsId}/deposit-and-mint/steth'
            .replace('{' + 'contractsId' + '}', encodeURIComponent(String(contractsId)));
        ...
        // Verify required parameter 'contractsId' is not null or undefined
        if (contractsId === null || contractsId === undefined) {
            throw new Error('Required parameter "contractsId" was null or undefined when calling depositAndMintSteth.');
        }
        // Verify required parameter 'depositAndMintSteth' is not null or undefined
        if (depositAndMintSteth === null || depositAndMintSteth === undefined) {
            throw new Error('Required parameter "depositAndMintSteth" was null or undefined when calling depositAndMintSteth.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(depositAndMintSteth, "DepositAndMintSteth")
        };
    ...
    /**
     * Generates the encoded transaction to deposit ETH into an StvStETH pool and optionally mint wstETH in the same transaction. Only supported for StvStETH pool vaults. 
     * @summary Deposit ETH and optionally mint wstETH in an StvStETH pool
     * @param contractsId The unique identifier of the Lido staking contracts
     * @param depositAndMintWsteth 
     */
   ...
   public async depositAndMintWsteth (contractsId: string, depositAndMintWsteth: DepositAndMintWsteth, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ body: PartialTransaction, status: number }> {

        const localVarPath = this.basePath + '/lidov3/{contractsId}/deposit-and-mint/wsteth'
            .replace('{' + 'contractsId' + '}', encodeURIComponent(String(contractsId)));
        ...
        // Verify required parameter 'contractsId' is not null or undefined
        if (contractsId === null || contractsId === undefined) {
            throw new Error('Required parameter "contractsId" was null or undefined when calling depositAndMintWsteth.');
        }
        // Verify required parameter 'depositAndMintWsteth' is not null or undefined
        if (depositAndMintWsteth === null || depositAndMintWsteth === undefined) {
            throw new Error('Required parameter "depositAndMintWsteth" was null or undefined when calling depositAndMintWsteth.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(depositAndMintWsteth, "DepositAndMintWsteth")
        };
   ...
   public async getLazyOracleReportCallData (contractsId: string, simulateAddress?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ body: LazyOracleReportCallDataResponse, status: number }> {
        ...
        return interceptorPromise.then(() => {
            if (Object.keys(localVarFormParams).length) {
                if (localVarUseFormData) {
                 ...
                 return new Promise<{ body: LazyOracleReportCallDataResponse, status: number }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions, (error, response, body) => {
                if (error) {
                    console.error('API call error:', error);
                    reject(error);
                    ...
                    if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                        body = ObjectSerializer.deserialize(body, "LazyOracleReportCallDataResponse");
                        resolve({ body: body, status: response.statusCode });
                    } else {
                        console.error('API response error:', response.statusCode);
                        resolve({ body: body, status: response.statusCode });
   ...
   public async revokeRole (contractsId: string, revokeRole: RevokeRole, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ body: PartialTransaction, status: number }> {
    ...
    /**
     * Generates the encoded transaction to set a new fee rate on the dashboard contract. Requires dual confirmation from DEFAULT_ADMIN_ROLE and NODE_OPERATOR_MANAGER_ROLE. 
     * @summary Encode a transaction to set the node operator fee rate on the dashboard
     * @param contractsId The unique identifier of the Lido staking contracts
     * @param setFeeRateRequest 
     */
   ...
   public async setFeeRate (contractsId: string, setFeeRateRequest: SetFeeRateRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ body: TransactionResponse, status: number }> {

        const localVarPath = this.basePath + '/lidov3/staking-vaults/{contractsId}/set-fee-rate'
            .replace('{' + 'contractsId' + '}', encodeURIComponent(String(contractsId)));
        ...
        // Verify required parameter 'contractsId' is not null or undefined
        if (contractsId === null || contractsId === undefined) {
            throw new Error('Required parameter "contractsId" was null or undefined when calling setFeeRate.');
        }
        // Verify required parameter 'setFeeRateRequest' is not null or undefined
        if (setFeeRateRequest === null || setFeeRateRequest === undefined) {
            throw new Error('Required parameter "setFeeRateRequest" was null or undefined when calling setFeeRate.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(setFeeRateRequest, "SetFeeRateRequest")
        };
    ...
    /**
     * Generates the encoded transaction to set a new fee recipient address on the dashboard contract. Requires NODE_OPERATOR_MANAGER_ROLE. 
     * @summary Encode a transaction to set the node operator fee recipient on the dashboard
     * @param contractsId The unique identifier of the Lido staking contracts
     * @param setFeeRecipientRequest 
     */
   ...
   public async setFeeRecipient (contractsId: string, setFeeRecipientRequest: SetFeeRecipientRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ body: TransactionResponse, status: number }> {

        const localVarPath = this.basePath + '/lidov3/staking-vaults/{contractsId}/set-fee-recipient'
            .replace('{' + 'contractsId' + '}', encodeURIComponent(String(contractsId)));
        ...
        // Verify required parameter 'contractsId' is not null or undefined
        if (contractsId === null || contractsId === undefined) {
            throw new Error('Required parameter "contractsId" was null or undefined when calling setFeeRecipient.');
        }
        // Verify required parameter 'setFeeRecipientRequest' is not null or undefined
        if (setFeeRecipientRequest === null || setFeeRecipientRequest === undefined) {
            throw new Error('Required parameter "setFeeRecipientRequest" was null or undefined when calling setFeeRecipient.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(setFeeRecipientRequest, "SetFeeRecipientRequest")
        };
    ...
    /**
     * Generates the encoded transaction calling VaultHub.settleLidoFees() to send any unsettled Lido fees from the vault to the Lido treasury. The on-chain call is permissionless but requires a fresh oracle report; it reverts if there are no unsettled fees or insufficient funds. 
     * @summary Encode a transaction to settle outstanding Lido fees for a vault
     * @param contractsId The unique identifier of the Lido staking contracts
   ...
   public async settleLidoFees (contractsId: string, simulateOnlyRequest: SimulateOnlyRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ body: TransactionResponse, status: number }> {

        const localVarPath = this.basePath + '/lidov3/staking-vaults/{contractsId}/settle-lido-fees'
            .replace('{' + 'contractsId' + '}', encodeURIComponent(String(contractsId)));
        ...
        // Verify required parameter 'contractsId' is not null or undefined
        if (contractsId === null || contractsId === undefined) {
            throw new Error('Required parameter "contractsId" was null or undefined when calling settleLidoFees.');
        }
        ...
        if (simulateOnlyRequest === null || simulateOnlyRequest === undefined) {
            throw new Error('Required parameter "simulateOnlyRequest" was null or undefined when calling settleLidoFees.');
        }
    ...
    /**
     * Returns the call data needed to submit the unguaranteed deposit transaction to the dashboard contract. Not allowed on pool (STV / STV_STETH) vaults — only on dedicated vaults. 

...
export class LidoWriteApi {
   ...
   public async consolidateValidators (contractsId: string, consolidateValidators: ConsolidateValidators, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ body: ConsolidateValidatorsResponse, status: number }> {
    ...
    /**
     * Generates the encoded transaction to deposit ETH into an StvStETH pool and optionally mint stETH shares in the same transaction. Only supported for StvStETH pool vaults. 
     * @summary Deposit ETH and optionally mint stETH shares in an StvStETH pool
     * @param contractsId The unique identifier of the Lido staking contracts
   ...
   public async setFeeRate (contractsId: string, setFeeRateRequest: SetFeeRateRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ body: VaultCreationStartResponse, status: number }> {
   ...
   public async setFeeRecipient (contractsId: string, setFeeRecipientRequest: SetFeeRecipientRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ body: VaultCreationStartResponse, status: number }> {

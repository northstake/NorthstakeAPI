...
export class WebhookEventWithdrawalClaimed {
    ...
    */
   'created_at': number;
   'data': WebhookEventWithdrawalClaimedAllOfData;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "data",
            "baseName": "data",
            "type": "WebhookEventWithdrawalClaimedAllOfData"
        }    ];

    static getAttributeTypeMap() {
        return WebhookEventWithdrawalClaimed.attributeTypeMap;
    }
}

export namespace WebhookEventWithdrawalClaimed {
}

...
export class WebhookEventReportUpdateAvailableAllOfData {
   'calldata': string;
    /**
    * Unix second timestamp as a string.
    */
   'report_timestamp': string;
    ...
    static getAttributeTypeMap() {
        return WebhookEventReportUpdateAvailableAllOfData.attributeTypeMap;
    }
}

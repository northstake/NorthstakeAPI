...
export class Transaction {
   'blockNumber': number;
    /**
    * Whether the transaction\'s block is finalized on chain. Transactions that are not finalized may still change or disappear in case of a chain reorganization.
    */
   'finalized': boolean;
   'timeStamp': Date;
   'hash': string;

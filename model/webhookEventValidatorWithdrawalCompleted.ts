...
export class WebhookEventValidatorWithdrawalCompleted {
    ...
    */
   'created_at': number;
   'data': WebhookEventValidatorWithdrawalCompletedAllOfData;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "data",
            "baseName": "data",
            "type": "WebhookEventValidatorWithdrawalCompletedAllOfData"
        }    ];

    static getAttributeTypeMap() {
        return WebhookEventValidatorWithdrawalCompleted.attributeTypeMap;
    }
}

export namespace WebhookEventValidatorWithdrawalCompleted {
}

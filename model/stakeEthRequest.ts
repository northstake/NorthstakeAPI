...
/**
* Request to stake ETH using Lido contracts
*/
export class StakeEthRequest {
    /**
    * Amount of ETH to stake (as string to preserve precision)
    */
   'amount': string;
    ...
    static getAttributeTypeMap() {
        return StakeEthRequest.attributeTypeMap;
    }
}

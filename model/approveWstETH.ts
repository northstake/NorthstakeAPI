...
export class ApproveWstETH {
    /**
    * Address that can spend/transfer the stETH on behalf of the owner.
    */
   'spender'?: string;
    /**
    * Amount of wstETH that the spender is approved to spend/transfer.
    */
   ...
   'simulateAddress'?: string;
    ...
    static getAttributeTypeMap() {
        return ApproveWstETH.attributeTypeMap;
    }
}

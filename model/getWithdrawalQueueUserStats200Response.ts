...
export class GetWithdrawalQueueUserStats200Response {
   'withdrawalQueue': GetPoolPreview200ResponsePool;
   'userAddress': string;
   'requests': Array<GetWithdrawalQueueUserStats200ResponseRequestsInner>;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "requests",
            "baseName": "requests",
            "type": "Array<GetWithdrawalQueueUserStats200ResponseRequestsInner>"
        }    ];

    static getAttributeTypeMap() {
        return GetWithdrawalQueueUserStats200Response.attributeTypeMap;
    }
}

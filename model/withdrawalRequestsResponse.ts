...
export class WithdrawalRequestsResponse {
   'withdrawalQueue': PoolPreviewResponsePool;
   'requests': Array<WithdrawalRequestsResponseRequestsInner>;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "requests",
            "baseName": "requests",
            "type": "Array<WithdrawalRequestsResponseRequestsInner>"
        }    ];

    static getAttributeTypeMap() {
        return WithdrawalRequestsResponse.attributeTypeMap;
    }
}

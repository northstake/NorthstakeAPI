...
export class BurnShares {
    /**
    * Amount of shares to burn, as a bigint string. Pass the literal \"max\" to burn the full minted liability (computed server-side).
    */
   ...
   'simulateAddress'?: string;
    ...
    static getAttributeTypeMap() {
        return BurnShares.attributeTypeMap;
    }
}

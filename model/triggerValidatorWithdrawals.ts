...
export class TriggerValidatorWithdrawals {
    /**
   ...
   'simulateAddress'?: string;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        {
            "name": "amountsGwei",
            "baseName": "amountsGwei",
            "type": "Array<string>"
        },
        {
            "name": "refundRecipient",
            "baseName": "refundRecipient",
            "type": "string"
        },
        {
    ...
    static getAttributeTypeMap() {
        return TriggerValidatorWithdrawals.attributeTypeMap;
    }
}

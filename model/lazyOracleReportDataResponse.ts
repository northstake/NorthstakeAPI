...
export class LazyOracleReportDataResponse {
   'reportData': LazyOracleReportDataResponseReportData;
   'isReportFresh': boolean;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            "name": "reportData",
            "baseName": "reportData",
            "type": "LazyOracleReportDataResponseReportData"
        },
        {
            "name": "isReportFresh",
    ...
    static getAttributeTypeMap() {
        return LazyOracleReportDataResponse.attributeTypeMap;
    }
}

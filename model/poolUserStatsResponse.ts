...
export class PoolUserStatsResponse {
   'pool': PoolUserStatsResponsePool;
   'userAddress': string;
   'balanceOf': string;
   'assetsOf': string;
   'stethUserStats': PoolUserStatsResponseStethUserStats | null;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            "name": "pool",
            "baseName": "pool",
            "type": "PoolUserStatsResponsePool"
        },
        {
            "name": "userAddress",
        ...
        },
        {
            ...
            "type": "PoolUserStatsResponseStethUserStats"
        }    ];

    static getAttributeTypeMap() {
        return PoolUserStatsResponse.attributeTypeMap;
    }
}

...
export class GetPoolUserStats200ResponseStethUserStats {
   'mintedStethSharesOf': string;
   'remainingMintingCapacitySharesOf': string;
   'unlockedStvOf': string;
   'isHealthyOf': boolean;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            ...
            "baseName": "mintedStethSharesOf",
            "type": "string"
        },
        {
            "name": "remainingMintingCapacitySharesOf",
            "baseName": "remainingMintingCapacitySharesOf",
            "type": "string"
        },
        {
            "name": "unlockedStvOf",
            "baseName": "unlockedStvOf",
            "type": "string"
        },
        {
            "name": "isHealthyOf",
            "baseName": "isHealthyOf",
            "type": "boolean"
        }    ];

    static getAttributeTypeMap() {
        return GetPoolUserStats200ResponseStethUserStats.attributeTypeMap;
    }
}

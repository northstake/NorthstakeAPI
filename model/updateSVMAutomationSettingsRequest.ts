...
export class UpdateSVMAutomationSettingsRequest {
    /**
    * Enable or disable automatic lazy oracle report updates for the staking vault.
    */
   'auto_update_lazy_oracle_report'?: boolean;
    ...
    static getAttributeTypeMap() {
        return UpdateSVMAutomationSettingsRequest.attributeTypeMap;
    }
}

...
export class DepositAndMintSteth {
   ...
   'referral'?: string;
    /**
    * Optional amount of stETH shares to mint against the deposit, as a bigint string. Pass \"0\" or omit to deposit without minting.
    */
   'stethSharesToMint'?: string;
    /**
   ...
   'simulateAddress'?: string;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        {
            "name": "stethSharesToMint",
            "baseName": "stethSharesToMint",
            "type": "string"
        },
        {

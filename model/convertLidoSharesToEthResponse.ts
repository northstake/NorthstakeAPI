...
export class ConvertLidoSharesToEthResponse {
    /**
    * The stETH shares amount as a bigint string.
    */
   'shares': string;
    /**
    * The ETH (stETH) amount as a bigint string in wei.
    */
   'eth': string;
    ...
    static getAttributeTypeMap() {
        return ConvertLidoSharesToEthResponse.attributeTypeMap;
    }
}

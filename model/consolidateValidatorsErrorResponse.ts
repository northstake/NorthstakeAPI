...
export class ConsolidateValidatorsErrorResponse {
    /**
    * Error message describing the validation failure
    */
   'message'?: string;
    /**
    * Array of invalid validator public keys
    */
   'invalidPubKeys'?: Array<string>;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        {
            "name": "invalidPubKeys",
            "baseName": "invalidPubKeys",
            "type": "Array<string>"
        }    ];

    static getAttributeTypeMap() {
        return ConsolidateValidatorsErrorResponse.attributeTypeMap;
    }
}

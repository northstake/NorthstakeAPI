...
export class CollectERC20FromVault {
    /**
    * Address of the ERC20 token to collect.
    */
   'token': string;
    /**
    * Address of the recipient of the tokens to collect.
    */
   'recipient': string;
    /**
    * Amount of the ERC20 token to collect.
    */
   'amount': string;
    /**
   ...
   'simulateAddress'?: string;
    ...
    static getAttributeTypeMap() {
        return CollectERC20FromVault.attributeTypeMap;
    }
}

...
export class MintShares {
    /**
    * Address of the recipient of the shares minted.
    */
   'recipient': string;
    /**
    * Amount of shares to mint, as a bigint string. Pass the literal \"max\" to mint the full remaining capacity (computed server-side).
    */
   ...
   'simulateAddress'?: string;
    ...
    static getAttributeTypeMap() {
        return MintShares.attributeTypeMap;
    }
}
